...
vision = GoogleAPI()
model = keras.models.load_model('app/img_clustering_augmented_model.h5')

@router.post("/submission/text")
async def submission_text(sub: Submission):
    '''
    This is a test endpoint that is a duplicate of the illustration submission endpoint 
    that allows the web dev team to test the endpoints.
    '''
...
async def submission_illustration(sub: ImageSubmission):
    """Function that assigns an image an ID and predicts
